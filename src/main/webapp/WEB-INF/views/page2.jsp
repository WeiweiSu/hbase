...
<body>
                ...
                <div class="row">
                	<form class="navbar-form navbar-left" role="search">
					  <div class="form-group">
					    <input type="text" id="fname" class="form-control" placeholder="Search By First Name" name="fname">
                	...
                	<div class="panel panel-info">
					  ...
					  <div id="search_title" class="panel-heading">Data will be displayed below</div>
					
					  <!-- Table -->
					  <div id="tablewrapper" class="table-responsive">
					  <table id="resultTable" class="table table-fixed table-bordered">
                ...
                <div class="row">
                	<form class="navbar-form navbar-left" role="search">
					  <div class="form-group">
					    ...
					    <label for="primarySpecialty">Search By Primary Specialty:</label>
					      <select class="form-control" id="primarySpecialty">
					      	<option></option>
					        ...
					        <option>REGISTERED DIETITIAN OR NUTRITION PROFESSIONAL</option>
					        <option>RHEUMATOLOGY</option>
					        <option>SINGLE OR MULTISPECIALTY CLINIC OR GROUP PRACTICE</option>
                	...
                	<div class="panel panel-info">
					  <!-- Default panel contents -->
					  <div id="search_title1" class="panel-heading">Data will be displayed below</div>
					
					  <!-- Table -->
					  <div class="table-responsive tablewrapper">
					  <table id="resultTable1" class="table table-fixed table-bordered">
	...
	$("#button1").click(function() {
		...
		if(fname == "" && lname == "") {
			$("#warning").html("Select at least one query criterion")
						.css("color", "red");
			return;
		}
		
		document.getElementById('search_title').innerHTML = "Loading.....";	
		$.getJSON( "search/" + fname + "+" + lname, function( data ) {
			var counter = 0;
			  var items = [];
			  var items1 = "<tbody>";
			  ...
			  $.each( data, function( key, val ) {
				...
				$.each( val, function(subkey, subval) {
					if(counter == 0) {
						itemshead += "<th>" + subkey + "</th>";
					}
					items1 += "<td>" + subval + "</td>";
					items.push("<td>" + subkey + " </td><td> " + subval + "</td>");
				});
				items1 += "</td>";
				items.push("</tr>");
				counter++;
			 ...
			 itemshead += "</tr></thead>";
			 items1 += "</tbody>";
			 document.getElementById('search_title').innerHTML = counter + " records found in our Database.";
			  document.getElementById('resultTable').innerHTML = itemshead + items1;
...
<script>
	...
	$("#button2").click(function() {
		...
		if(ps == "" && state == "") {
			$("#warning1").html("Select at least one query criterion")
						.css("color", "red");
			return;
		...
		$.getJSON( "search1/" + ps + "+" + state, function( data ) {
			var counter1 = 0;
			  var items2 = "<tbody>";
			  var itemshead = "<thead><tr>";
			  $.each( data, function( key, val ) {
			 ...
			 itemshead += "</tr></thead>";
			 items2 += "</tbody>";
			 document.getElementById('search_title1').innerHTML = counter1 + " records found in our Database.";
			  document.getElementById('resultTable1').innerHTML = itemshead + items2;
			  /* items1.appendTo("table"); */
			  /* $( "<ul/>", {
			    "class": "my-new-list",
			    html: items.join( "" )
